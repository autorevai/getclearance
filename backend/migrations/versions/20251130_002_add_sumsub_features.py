...
This migration adds:
1. Enhanced screening_hits fields (match_type, sentiment, source_reputation - confidence & pep_relationship already exist)
2. Document fraud detection fields (security_features_detected - fraud_signals already exists)
...
def upgrade() -> None:
    ...
    # ============================================
    # Note: confidence is already DECIMAL(5,2) and pep_relationship already exists
    ...
    # ============================================
    # Note: fraud_signals already exists as JSONB
